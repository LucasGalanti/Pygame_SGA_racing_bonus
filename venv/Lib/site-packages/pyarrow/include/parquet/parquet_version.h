...
#define PARQUET_VERSION_MAJOR 15
#define PARQUET_VERSION_MINOR 0
#define PARQUET_VERSION_PATCH 0

#define PARQUET_SO_VERSION "1500"
#define PARQUET_FULL_SO_VERSION "1500.0.0"

// define the parquet created by version
#define CREATED_BY_VERSION "parquet-cpp-arrow version 15.0.0"
